  ...
  return (
    <div className="min-h-screen  mt-5 lg:mt-16 px-0 sm:px-6 lg:px-8 max-w-4xl mx-auto text-sm">
      ...
      <Tabs defaultValue="frontend" className="max-w-3xl mx-auto">
        <TabsList className="grid w-full grid-cols-3 md:grid-cols-5 mb-16 md:mb-8 gap-4">
    ...
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-md">
      <CardContent className="p-6">
        <div className="flex items-start space-x-4">
          <div className="w-16 h-16 relative rounded-lg md:block hidden overflow-hidden bg-white flex-shrink-0 border border-gray-100">
            <img 
              src={icon} 
              alt={`${name} icon`} 
          ...
          <div className="flex-1">
            <h3 className="text-xl font-medium text-slate-800 mb-2">{name}
              <Link className="text-[12px] ml-4 text-green-400 italic bg-green-100 p-1 rounded-full" href={docsLink}>
              {docsLink}
              </Link>
            </h3>
