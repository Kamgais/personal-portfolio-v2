...
export default function ProfileSidebar() {
  return (
    <div className="space-y-4 lg:space-y-6">
      {/* Profile Card */}
      <div className="backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl p-4 sm:p-6">
        <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-3 w-full">
            <div className="inline-flex items-center gap-2 px-3 py-2 bg-green-50 border border-green-200 rounded-full">
              <BriefcaseBusiness size={14} className="text-green-600 animate-pulse sm:w-4 sm:h-4" />
              <span className="text-xs sm:text-sm font-medium text-green-700">Available for work</span>
            </div>
      ...
      <div className="backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl p-4 sm:p-6">
        <div className="space-y-3 sm:space-y-4">
          <h3 className="font-semibold text-slate-900 text-center text-sm sm:text-base mb-3 sm:mb-4">Let&apos;s Connect</h3>
